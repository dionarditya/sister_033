...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/twelements/dist/css/index.min.css" />
 ...
 <h1 class="text-4xl font-bold tracking-tight text-gray900">Pendatang Baru</h1>
...
Pertama, salah satu tempat wisata di Bali yang paling banyak 
dikunjungi adalah Ubud, baik dikunjungi oleh wisatawan lokal 
maupun mancanegara. Objek wisata Ubud Bali membuat banyak
 pengunjung yang selalu ingin kembali
 </div>
...
Minuman selamat datang, masker, dan makan siang gratis.
 </p>
 </form>
 </div>
 <div class="md:flex font-sans pt-8">
 <div class="md:shrink-0">
 <img src="https://th.bing.com/th/id/OIP.eBKzkqnqMDa8hAG2_aGPUQHaEd?pid=ImgDet&rs=1" class="h-48 w-full md:h-full md:w-56 inset-0 wfull object-cover rounded-lg" loading="lazy" />
 </div>
<form class="p-6">
 <div class="flex flex-wrap">
 <h1 class="flex-auto font-medium text-slate-900">
...
<div class="flex items-baseline mt-4 mb-6 pb-6 border-b borderslate-200">
Pertama, salah satu tempat wisata di Bali yang paling banyak dikunjungi 
adalah Ubud, baik dikunjungi oleh wisatawan lokal maupun mancanegara. Objek 
wisata Ubud Bali membuat banyak pengunjung yang selalu ingin kembali
 </div>
<div class="flex space-x-4 mb-5 text-sm font-medium">
 <div class="flex-auto flex space-x-4">
 <button class="h-10 px-6 font-semibold rounded-full bg-violet-600 text-white" type="submit">
